...
/**
 * @file plugins/themes/portal/PortalThemePlugin.inc.php
 *
 * Copyright (c) 2014-2021 Simon Fraser University
 * Copyright (c) 2003-2021 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class PortalThemePlugin
 * @ingroup plugins_themes_portal
 *
 * @brief Portal UERR theme
 */

import('lib.pkp.classes.plugins.ThemePlugin');

class PortalThemePlugin extends ThemePlugin {
	/**
	...
	public function init() {
		...
		$this->addOption('typography', 'FieldOptions', [
			'type' => 'radio',
			'label' => __('plugins.themes.portal.option.typography.label'),
			'description' => __('plugins.themes.portal.option.typography.description'),
			'options' => [
				[
					'value' => 'notoSans',
					'label' => __('plugins.themes.portal.option.typography.notoSans'),
				],
				[
					'value' => 'notoSerif',
					'label' => __('plugins.themes.portal.option.typography.notoSerif'),
				],
				[
					'value' => 'notoSerif_notoSans',
					'label' => __('plugins.themes.portal.option.typography.notoSerif_notoSans'),
				],
				[
					'value' => 'notoSans_notoSerif',
					'label' => __('plugins.themes.portal.option.typography.notoSans_notoSerif'),
				],
				[
					'value' => 'lato',
					'label' => __('plugins.themes.portal.option.typography.lato'),
				],
				[
					'value' => 'lora',
					'label' => __('plugins.themes.portal.option.typography.lora'),
				],
				[
					'value' => 'lora_openSans',
					'label' => __('plugins.themes.portal.option.typography.lora_openSans'),
				],
			],
			'default' => 'notoSans',
		]);
		...
		$this->addOption('baseColour', 'FieldColor', [
			'label' => __('plugins.themes.portal.option.colour.label'),
			'description' => __('plugins.themes.portal.option.colour.description'),
			'default' => '#1E6292',
		]);
		...
		$this->addOption('showDescriptionInJournalIndex', 'FieldOptions', [
			'label' => __('manager.setup.contextSummary'),
				...
				[
					'value' => true,
					'label' => __('plugins.themes.portal.option.showDescriptionInJournalIndex.option'),
				],
			],
			'default' => false,
		]);
		$this->addOption('useHomepageImageAsHeader', 'FieldOptions', [
			'label' => __('plugins.themes.portal.option.useHomepageImageAsHeader.label'),
			'description' => __('plugins.themes.portal.option.useHomepageImageAsHeader.description'),
				'options' => [
				[
					'value' => true,
					'label' => __('plugins.themes.portal.option.useHomepageImageAsHeader.option')
				],
			],
			'default' => false,
		]);
	...
	function getDisplayName() {
		return __('plugins.themes.portal.name');
	}
	...
	function getDescription() {
		return __('plugins.themes.portal.description');
	}
}
